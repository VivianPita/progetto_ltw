...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="toeletta.css">
</head>
<body>
  <header>
        ...
        <div class = "card-content">
            ...
            <form action="php/reservation.php" method="POST">
                <div class = "form-row">
                    ...
                    <input type="date" id="seleziona-data" name="data" value="2023-05-31" min="2023-05-31" max="2023-12-31" required>

                    <select name = "ora" required>
                        <option value = "selezione-ora">Seleziona l' ora</option>
                ...
                <div class = "form-row">
                    ...
                    <input type = "text" name="numero" placeholder="Numero di telefono" required>
                </div>
